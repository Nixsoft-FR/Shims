...
namespace Shims.NET48.TestContext
{
    public class MyClass
    {
        ...
        public MyOtherClass MyMethodReturninMyOtherClass()
        {

            return new MyOtherClass()
            {
                MyFirstProperty = "MyFirstProperty-concrete",
                MySecondProperty = "MySecondProperty-concrete",
                MyThirdProperty = "MyThirdProperty-concrete",
                MyFourthProperty = "MyFourthProperty-concrete",
                MyFifthProperty = "MyFifthProperty-concrete"
            };
        }
